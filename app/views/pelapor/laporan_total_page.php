                        ...
                        <div class="col-md-12 grid-margin">
                            <div class="row">
                                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                                    ...
                                    <h3 class="font-weight-bold">Total Laporan yang pernah anda buat berjumlah <span class="text-primary"><?php echo $db->CountAllLaporanWithNik($_SESSION['nik_log']); ?></span></h3>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            if ($db->ShowAllLaporanWithNik($_SESSION['nik_log']) == 0) {
                                            ?>
                                                <tr>
                                                    <td colspan="5">
                                                ...
                                                $SA_LAPORAN = $db->ShowAllLaporanWithNik($_SESSION['nik_log']);
