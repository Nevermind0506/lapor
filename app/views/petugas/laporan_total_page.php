                                            ...
                                            ?>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button type="button" class="btn btn-sm btn-info" data-toggle="modal" data-target="#tanggapan<?php echo $all_laporan['id_laporan']; ?>">
                                                                Tanggapi
                                                            </button>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <!-- Modal Tanggapan-->
                                                    <div class="modal fade" id="tanggapan<?php echo $all_laporan['id_laporan']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
